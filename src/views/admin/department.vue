...
import { departmentAdd, departmentDelId, departmentEdit, departmentAll,departsGetBySchoolId } from "../../http/department";
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            MainTitle: "部门",
            FuncObj: [departmentAdd, departmentDelId, departmentEdit, departmentAll],
            // FuncObj: [departmentAdd, departmentDelId, departmentEdit, departsGetBySchoolId],
    ...
    mounted() {//渲染完毕就开始调用
        ...
        console.log(  "拿到的属性 id 是",this.$route.query.id );
        if ( this.$route.query.id     ) {
            this.FuncObj[3]  =   departsGetBySchoolId;
            this.requestData.schoolId = this.$route.query.id;
        }
